...
plugin_identifier = "poweroffafterprint"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_poweroffafterprint"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-PowerOffAfterPrint"
...
# module
plugin_description = (
    """Automatically power off your 3d printer when a print is finished."""
)
...
plugin_url = "https://github.com/kforth/OctoPrint-PowerOffAfterPrint"
